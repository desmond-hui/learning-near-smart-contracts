...
let FungibleToken = (_dec = NearBindgen({}), _dec2 = initialize({}), _dec3 = view({}), _dec4 = view({}), _dec5 = call({}), _dec(_class = (_class2 = class FungibleToken {
  constructor() {
  ...
  internalWithdraw({
    ...
    if (this.accounts.get(senderId)) {
      balanceOfSender = this.accounts.get(senderId);
    }
  ...
  internalDeposit({
    ...
    if (this.accounts.get(receiverId)) {
      balanceOfReceiver = this.accounts.get(receiverId);
    }
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getTotalSupply", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "getTotalSupply"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getBalance", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "getBalance"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "transferTokens", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "transferTokens"), _class2.prototype)), _class2)) || _class);
function transferTokens() {
  ...
  let _result = _contract.transferTokens(_args);
...
function getBalance() {
  ...
  let _args = FungibleToken._getArgs();
  let _result = _contract.getBalance(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(FungibleToken._serialize(_result));
}
function getTotalSupply() {
  ...
  let _args = FungibleToken._getArgs();
  let _result = _contract.getTotalSupply(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(FungibleToken._serialize(_result));
}
function init() {
  let _state = FungibleToken._getState();
...
export { getBalance, getTotalSupply, init, transferTokens };
